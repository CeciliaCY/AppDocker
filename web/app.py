...
flask_secretKey = os.environ['flask_secretKey']
flask_admin_password = os.environ['flask_admin_password']
...
if (User.query.filter_by(username="admin").count()==0 ):
    admin_account = User (username="admin", password= sha256_crypt.using(rounds=324333).hash(flask_admin_password), twofa=flask_2fa, role="admin")
